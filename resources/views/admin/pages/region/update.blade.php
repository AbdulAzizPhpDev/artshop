    ...
    <div class="main_info">
        <div class="add product_e addseller">
            ...
            <form action="{{route('admin.region.store',['lang' => app()->getLocale()])}}" method="post">
                ...
                <div class="b5">
                    <div class="inp_titles">{{__('admin_regions_update')}}</div>

                    <div class="b6">
                        <div class="b7">
                            <div class="inp_label">{{__('admin_region_name_uz')}}</div>
                            <input type="text" required class="inp2" name="name_uz" value="{{$region->name_uz}}">

                        </div>
                        <div class="b7">
                            <div class="inp_label">{{__('admin_region_name_ru')}}</div>
                            <input type="text" required class="inp2" name="name_ru" value="{{$region->name_ru}}">
                        </div>
                    </div>
