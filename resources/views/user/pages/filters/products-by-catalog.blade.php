    ...
    <div class="catalog">
        <div class="content">
            <div class="navi">
                ...
                <a href="{{route('user.catalog',app()->getLocale())}}" class="navi_point">{{__('catalog')}}</a>
                <a class="navi_point">{{$catalog['name_'.app()->getLocale()]}}</a>
            </div>
            <div class="page_title">{{$catalog['name_'.app()->getLocale()]}}</div>
            <div class="b5">

                <input type="hidden" value="{{$catalog->id}}" name="catalog" id="catalog">
                <div class="filter">
...
{{--                    </div>--}}
                    ...
                    <div class="filter_sect">
                        ...
                        <a href="{{route('user.products_by_catalog',['lang'=>app()->getLocale(),'catalog_id'=>$catalog->id])}}"
